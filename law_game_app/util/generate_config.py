...
def generate_agent_config(
    ...
    module = module if module is not None else "law_game_app.app.core.agent." + class_name
...
def generate_config(agent_name, introduction, target, instruction):
    ...
    root_path = ""
    agent_path = "/opt/model/agentUniverse/law_game_app/app/core/agent/court/" + agent_name + ".yaml"
    prompt_path = "/opt/model/agentUniverse/law_game_app/app/core/prompt/court/" + agent_name + ".yaml"
