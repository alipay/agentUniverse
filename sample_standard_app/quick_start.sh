    ...
    if ! command -v conda &> /dev/null; then
        ...
        if [[ "$(uname)" == "Darwin" ]]; then
            if [[ "$(uname -m)" == "x86_64" ]]; then
                curl -o ~/miniconda3/miniconda.sh https://mirrors.tuna.tsinghua.edu.cn/anaconda/archive/Miniconda3-py310_23.3.1-0-MacOSX-x86_64.sh -o ~/miniconda3/miniconda.sh
            elif [[ "$(uname -m)" == "arm64" ]];then
                curl -o ~/miniconda3/miniconda.sh https://mirrors.tuna.tsinghua.edu.cn/anaconda/archive/Miniconda3-py310_23.3.1-0-MacOSX-arm64.sh -o ~/miniconda3/miniconda.sh
            fi
        # If on Linux
        elif [[ "$(uname)" == "Linux" ]]; then
            if [[ "$(uname -m)" == "x86_64" ]]; then
                curl -o ~/miniconda3/miniconda.sh https://mirrors.tuna.tsinghua.edu.cn/anaconda/archive/Miniconda3-py310_23.3.1-0-Linux-x86_64.sh -o ~/miniconda3/miniconda.sh
                if [[ "$(uname -m)" == "arm64" ]];then
                    curl -o ~/miniconda3/miniconda.sh https://mirrors.tuna.tsinghua.edu.cn/anaconda/archive/Miniconda3-py310_23.3.1-0-Linux-arm64.sh -o ~/miniconda3/miniconda.sh
                fi
