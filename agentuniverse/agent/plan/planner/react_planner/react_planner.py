...
class ReActPlanner(Planner):
    ...
    def invoke(self, agent_model: AgentModel, planner_input: dict,
        ...
        self.tools = self.acquire_tools(agent_model.action)
        ...
        agent = create_react_agent(llm.as_langchain(), self.tools, prompt.as_langchain())
    ...
    def handle_prompt(self, agent_model: AgentModel, planner_input: dict) -> Prompt:
        ...
        lc_tool_names = "|".join([lc_tool.name for lc_tool in self.tools])
